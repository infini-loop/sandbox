...
import ${groupId}.bootstrap.LifeCycleManager;
import ${groupId}.event.client.InMemoryEventClient;
import ${groupId}.event.client.InMemoryEventModule;
import ${groupId}.http.client.HttpClient;
import ${groupId}.http.client.StatusResponseHandler.StatusResponse;
import ${groupId}.http.client.jetty.JettyHttpClient;
...
import ${groupId}.testing.Closeables;
...
import static ${groupId}.http.client.JsonResponseHandler.createJsonResponseHandler;
import static ${groupId}.http.client.Request.Builder.prepareDelete;
import static ${groupId}.http.client.Request.Builder.prepareGet;
import static ${groupId}.http.client.Request.Builder.preparePost;
import static ${groupId}.http.client.Request.Builder.preparePut;
import static ${groupId}.http.client.StaticBodyGenerator.createStaticBodyGenerator;
import static ${groupId}.http.client.StatusResponseHandler.createStatusResponseHandler;
import static ${groupId}.json.JsonCodec.listJsonCodec;
import static ${groupId}.json.JsonCodec.mapJsonCodec;
import static ${package}.PersonEvent.personAdded;
import static ${package}.PersonEvent.personRemoved;
import static ${groupId}.testing.Assertions.assertEqualsIgnoreOrder;
