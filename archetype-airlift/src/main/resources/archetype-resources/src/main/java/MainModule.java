...
import static ${groupId}.configuration.ConfigBinder.configBinder;
import static ${groupId}.discovery.client.DiscoveryBinder.discoveryBinder;
import static ${groupId}.event.client.EventBinder.eventBinder;
import static ${groupId}.jaxrs.JaxrsBinder.jaxrsBinder;
