...
public final class FormatUtils
{
    ...
    private static DecimalFormat getFormat(double value)
    {
        ...
        if (value < 10) {
            ...
            format = new DecimalFormat("${symbol_pound}.${symbol_pound}${symbol_pound}");
        }
        else if (value < 100) {
            // show up to one decimal to get 3 significant digits
            format = new DecimalFormat("${symbol_pound}.${symbol_pound}");
        }
        else {
            // show no decimals -- we have enough digits in the integer part
            format = new DecimalFormat("${symbol_pound}");
        }
