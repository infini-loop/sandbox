...
import ${package}.ClientOptions.ClientSessionProperty;
...
public class TestClientOptions
{
    ...
    public void testDefault()
    {
        ...
        assertEquals(session.getSource(), "${artifactId}");
    }
    ...
    {
        new ClientSessionProperty("${symbol_escape}u2603=value");
    }

    @Test(expectedExceptions = IllegalArgumentException.class)
    public void testInvalidCharsetPropertyValue()
    {
        new ClientSessionProperty("name=${symbol_escape}u2603");
    }
